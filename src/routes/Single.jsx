        ...
        <div className="flex flex-col md:flex-row items-start gap-8 md:items-center">
          <div className="flex-shrink-0">
            <img
              src={data.thumbnail}
              alt={data.title}
              className="w-[300px] h-[360px] object-cover border-t border-r border-b border-l"
            />
          </div>
          <div className="flex-grow">
            ...
            <p className="mb-2 text-lg font-semibold mt-6">
            ...
            <div className="w-[230px] mt-4">
              <Link to="/Login">
                {" "}
                <button className="w-full h-10 px-4 py-2 bg-[#0053A0] text-white rounded-lg hover:bg-blue-600">
                  Buy Now
                </button>{" "}
              </Link>
              <button className="w-full h-10 px-4 py-2 bg-[#3498CA] text-white rounded-lg mt-2 hover:bg-blue-600">
                Add to Cart
              </button>
              <button className="w-full h-10 px-4 py-2 bg-white text-[#0053A0] border border-[#0053A0] rounded-lg mt-2 hover:bg-[#0053A0] hover:text-white">
                Add to Wishlist
              </button>
            </div>
          </div>
