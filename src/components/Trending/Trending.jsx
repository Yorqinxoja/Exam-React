...
const Trending = () => {
  ...
  return (
   <>
    <div className="flex md:flex-row border-r border-b border-l border-t border-gray-200">
        <div className="flex-col p-4">
          <div className="text-sm text-gray-500 mb-2">
            {t('featured')}
          </div>
          <img src={ebay} alt="Ebay Logo" className="w-24 mb-4 ml-[-2px]" />
          <i className="text-xl font-semibold mb-2 text-gray-600 font-sans text-start">
            {t('deals_made_easy')}
          </i>
          <div className="text-gray-600 mb-4">
            {t('free_shipping_prices')}
          </div>
          <button className=" px-3 py-2 w-[200px] bg-white border border-gray-400 rounded shadow hover:bg-[black] hover:text-[white] flex items-center">
      ...
      <div className='my-[40px] flex'>
        <i className="text-[24px] font-[400] ml-2 mb-2 font-sans text-start">
          {t('todays_deals')}
        </i>
        <span className='flex hover:underline text-gray-600 mr-[680px] text-[24px]'>
